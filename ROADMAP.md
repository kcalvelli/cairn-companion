...
Open work: `cli-client` deferred subcommands, `tui-session-management`, `cairn-integration` (lives in the cairn repo). Nothing on this list is blocking — the project is shippable as-is.
